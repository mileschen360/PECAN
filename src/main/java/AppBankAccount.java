...
public class AppBankAccount{
    ...
    public AppBankAccount(int n_nodes_in){
    ...
    /*
    boolean less_at(int node_id, BankAccount another){
        int val_this = this.vals_over_nodes[node_id];
        int val_another = another.vals_over_nodes[node_id];
        return val_this < val_another;
    }*/

    public AppBankAccount merge(AppBankAccount another) {
        AppBankAccount merged = new AppBankAccount(another.n_nodes);
